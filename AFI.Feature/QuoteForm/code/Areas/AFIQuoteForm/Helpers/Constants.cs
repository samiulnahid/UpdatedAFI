namespace AFI.Feature.QuoteForm.Areas.AFIQuoteForm.Helpers
{
    ...
    {
        public const string QUOTE_FORMS_LOGGER_NAME = "QuoteFormsLogger";
        public const string Email_TemplateId = "{89E09F73-96E0-4751-A8ED-D77D7B6146F3}";
        public const string Email_ItemId = "{B78D131B-E375-47AC-AF93-C5D52723513C}";
    ...
    public static class QuoteleadformConstants
    {
        public const string QUOTE_FORMS_LOGGER_NAME = "QuoteFormsLogger";
        public const string Email_TemplateId = "{89E09F73-96E0-4751-A8ED-D77D7B6146F3}";
        public const string QuoteLeadFormEmail_Email_ItemId = "{1E85F5C7-AAED-4075-8C7B-23B6A02CA946}";
        public const string Email_Subject = "Email Subject";
        public const string Email_Recipients = "Email Recipients";
        public const string Email_Sender = "Email Sender";
        public const string Email_Body = "Email Body";

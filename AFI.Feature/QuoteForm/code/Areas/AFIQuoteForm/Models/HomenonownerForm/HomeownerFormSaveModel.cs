...
{
	public class HomenonownerFormSaveModel : CommonFormSaveModel
	{
        ...
        public string LengthOfLeasingAgreement { get; set; }
        [JsonConverter(typeof(YesNoBooleanConverter))]
        public bool AreTenantsRequiredToCarryLiabilityCoverage { get; set; }
        public string PropertyReasonForVacancy { get; set; }
    }
}
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    ...
    <link rel="stylesheet" href="~/asset/css/vote/vote-form.css" />
  </head>
  ...
  <body>
    ...
    <script type="text/javascript" src="/asset/js/jsLibrary/chart.js"></script>
    ...
    <script>
      ...
      function fetchCandidateData() {
        const url = `/api/sitecore/AFIReport/GetPrevVoteCountReportForResult`;
      ...
      function downloadCSV(e) {
        e.preventDefault();
        const url = `/api/sitecore/AFIReport/DownloadPrevVoteReportAsCSV`;

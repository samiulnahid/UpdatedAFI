<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoteTemplate.aspx.cs"
%> <%@ Register TagPrefix="sc" Namespace="Sitecore.Mvc" Assembly="Sitecore.Mvc"
%> <%@ Register TagPrefix="scf" Namespace="Sitecore.ExperienceForms.Mvc"
    ...
    <form id="form1" runat="server">
      ...
      <section class="vote-step-two">
        <div class="contbtn pdf_btn">
          <input
            value="Download PDF"
            type="button"
            class="continue button button--large-text"
      ...
      <section>
        <div class="login-form-container">
          ...
          <h2 class="vote_title">
            Vote For 2024 AFIE Subscribers' Advisory Committee
          </h2>

          <p class="text_msg" id="help_text_msg">
            Please enter the Member Number. The rest of the fields will populate
            automatically.
          </p>

          <p class="text_msg" id="required_text_msg" style="display: none">
          ...
          <section class="form_info_vote">
            ...
            <div class="form-group">
              ...
              <input
                type="text"
                id="afi_member_number"
                class="txtVoteMemberNumber"
                name="afi_member_number"
                required
              />
            </div>
            ...
            <div class="form">
              <div id="vote_step_two">
                ...
                <div id="vote_step_two_name">
                  <h4 class="txt-dear">
                    Dear <span id="txtDearMemberName"> </span>,
                  </h4>
                </div>

                <div id="vote_step_two_text_2">
                  <p
                    data-sc-field-key="43BB6842D7104574A37E5EF4B9D6C094"
                    class=""
                  >
                    KNOW ALL PERSONS BY THESE PRESENTS, that the undersigned
                    member of the Armed Forces Insurance Exchange hereby
                    appoints CMSgt Danny R. Walker, ANG (Ret) as proxy, with
                    full power of substitution, for and the name of the
                    undersigned, at the Annual Meeting of the members of the
                    Exchange to be held Thursday, the 20th day of June, 2024, at
                    the Armed Forces Insurance Headquarters, 550 Eisenhower Rd.,
                    Leavenworth, Kansas. The meeting will be called to order at
                    1700 hours CDT, with respect to the following:
                  </p>
                </div>
                ...
                <div id="vote_step_two_text_2">
                  <div>
                    <p
                      data-sc-field-key="8C0F914E6B074DFE8B1C9CFD6185FC34"
                      class="txt-no"
                      style="margin-bottom: 2px !important"
                    >
                      1. To receive and consider reports of the
                      Attorney-in-Fact's Board of Directors.
                    </p>
                    <p
                      data-sc-field-key="0F4F7BC47C7146E49735D19A62F614CB"
                      class="txt-no"
                      style="margin-bottom: 2px !important"
                    >
                      2. To elect a member to the Exchange's Subscribers'
                      Advisory Committee.
                    </p>
                    <p
                      data-sc-field-key="0F4F7BC47C7146E49735D19A62F614CB"
                      ...
                      style="margin-bottom: 2px !important"
                    >
                      3. To vote on any and all business which may be properly
                ...
                <form method="post" novalidate>
                  <div class="form___wrapper">
                    <div class="txtbody dv-content-vote-bottom">
                      ...
                      <p class="txt-candidate white__text">
                        Please vote for, against or abstain the candidate below:
                      </p>
                      ...
                      <div class="person">
                        ...
                        <label class="rdo-css">
                          <input
                            type="radio"
                            name="Colonel Kay Wakatake, U.S. Army, Retired"
                            value="For"
                          /><span></span>
                          For
                        </label>
                      ...
                      <div class="person">
                        ...
                        <label class="rdo-css">
                          <input
                            type="radio"
                            name="Colonel David L. Musgrave, Army, Retired"
                            value="For"
                          /><span></span>
                          For
                        </label>
      ...
      <script>
        document
          ...
          .addEventListener("click", function () {
            const memberNumValue =
              document.getElementById("afi_member_number")?.value;

            if (!memberNumValue) {
              const confirmation = confirm(
                "Are you sure you want to download the PDF with blank fields?"
              );
            ...
            const voteTwoBottom = document.querySelector(
              ".vote-step-two .dv-content-vote-bottom"
            );
            const help_text_msg = document.querySelector("#help_text_msg");
            const required_text_msg =
              document.querySelector("#required_text_msg");
            ...
            voteTwoBottom.style.padding = "0 30px";
            ...
            setTimeout(function () {
              ...
              container.style.gridTemplateColumns = "1fr";
              voteTwoBottom.style.padding = "0 30px 30px";
      ...
      <script>
        ...
        // on change of txtVoteName field dear < name > will update
        const txtVoteName = document.querySelector("input.txtVoteName");
        txtVoteName.addEventListener("input", (e) => {
          $("#txtDearMemberName").html(e.target.value);
        });
      </script>
    </form>
  </body>

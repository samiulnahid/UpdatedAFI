  ...
  <body class="configure-page">
    <form id="form1" runat="server">
      ...
      <div class="box configure-box">
        ...
        <h1>Vote for the AFIE Subscribers' Advisory Committee</h1>

        <div class="button__container">
          <a href="/vote/PreviewVote" id="vote_page_url" class="button" style="display: none !important;">Visit Vote Page</a>
          <a href="/sitecore/admin/vote/VoteResult.aspx" id="result_page_url" class="button">Result Page</a>
          <button type="button" class="button" id="configureBtn">Configure</button>
        </div>
      </div>

...
<body>
    ...
    <div class="container">
        ...
        <div class="download__container">
            <a href="/api/sitecore/Prospect/DownloadSuspectCSV" class="">Download CSV</a>
        </div>
    </div>
    <!-- Search result -->
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(jsonDataList, function (index, item) {
                        ...
                        row.append("<td><input class='checkbox data_checkbox' type='checkbox' data-id='" + item.SuspectID + "'  " + disabledAttribute + " " + checkedAttribute + "></td>");

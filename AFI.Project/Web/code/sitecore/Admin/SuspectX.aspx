  ...
  <body>
    <div class="container">
      ...
      <div class="download__container">
        <a href="/api/sitecore/Prospect/DownloadSuspectCSV" id="csvDownloadBtn">Sustect <i class="fa-solid fa-file-csv"></i></a>
      </div>
    </div>
    <!-- Search result -->
    ...
    <section class="container temp_table">
      <!-- Table Start  -->
      <h1 class="page_title">Sync Table</h1>
      ...
      <div id="temp_pagination" class="pagination"></div>
    ...
    <script>
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            $.each(jsonDataList, function (index, item) {
              ...
              var warningMsg = isDisble ? "Data already synced" : "";

              const isSelected = selectedData.find((obj) => obj.id == item.SuspectID);
      ...
      function downloadCSV(e) {
        e.preventDefault();
        const { page, pageSize, leadStatus, syncFilter, coverage } = urlQuery;
        const url = `/api/sitecore/Prospect/DownloadSuspectCSV?leadStatus=${leadStatus}&syncFilter=${syncFilter}&coverage=${coverage}`;

...
<head runat="server">
    ...
    .table_container.data-table th:last-child,
    .table_container.data-table td:last-child {
...
<body>
    ...
    <div class="container">
    <h1 class="iplog_title">Temp Suspect Data</h1>
    
    <div class="download__container">
        <a href="/api/sitecore/Prospect/DownloadSuspectTempCSV" class="">Download CSV</a>
    </div>
    </div>
    <!-- Search result -->
        ...
        <div class="api_result">
            ...
            <div class="filter_container">
                ...
                <div class="filter_coverage">
                 ...
                 <!-- Coverage Type  -->
                 <div class="synced__filter__wrapper">
                  <label for="synced__filter">Type:</label>
                  <select id="coverageType__filter" name="coverageType" class="input__field">
                      <option value="">All</option>
                      <option value="Quote">Sitecore</option>
            ...
            <div class="table_container data-table">
                <table>
                    <thead>
                        <tr>
    ...
    <section class="container temp_table">
        <!-- Table Start  -->
        <h1 class="page_title">Suspective Table</h1>
    ...
    <script>
        ...
        function fetchDataFromApi() {
            const { page, pageSize, leadStatus, syncFilter, coverage, coverageType } = urlQuery;
            const url = `/api/sitecore/Prospect/GetTempProspectData?page=${page}&pageSize=${pageSize}&leadStatus=${leadStatus}&syncFilter=${syncFilter}&coverage=${coverage}&coverageType=${coverageType}`
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(jsonDataList, function (index, item) {
                        ...
                        const AddressData = item?.Address ? `${item?.Address}, ` :  "";
                        const CityData = item?.City ? `${item?.City}, ` :  "";
                        const StateData = item?.State ? `${item?.State}, ` :  "";
                        const ZipCodeData = item?.ZipCode ? `${item?.ZipCode}` :  "";

                        const FullAddress = AddressData + CityData + StateData + ZipCodeData;
                        ...
                        row.append("<td>" + item.EntityType || "" + "</td>");

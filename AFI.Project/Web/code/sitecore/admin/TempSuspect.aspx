  ...
  <body>
    <div class="container">
      ...
      <div class="download__container">
        <a href="/api/sitecore/Prospect/DownloadSuspectTempCSV" id="csvDownloadBtn"
          >Temp Suspect <i class="fa-solid fa-file-csv"></i
        ></a>
      </div>
    </div>
    <!-- Search result -->
    ...
    <section class="container temp_table">
      <!-- Table Start  -->
      <h1 class="page_title">Susceptive Table</h1>
    ...
    <script>
      ...
      function downloadCSV(e) {
        e.preventDefault();
        const { page, pageSize, leadStatus, syncFilter, coverage } = urlQuery;
        const url = `/api/sitecore/Prospect/DownloadSuspectTempCSV?leadStatus=${leadStatus}&syncFilter=${syncFilter}&coverage=${coverage}`;
